...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 04, 2016 at 11:59 PM
...
--
-- Database: `aimc_mobile`
--

-- --------------------------------------------------------

--
-- Table structure for table `default_district`
--

CREATE TABLE IF NOT EXISTS `default_district` (
...
--
-- Dumping data for table `default_district`
--

INSERT INTO `default_district` (`DISTRICT_ID`, `DISTRICT_CODE`, `DISTRICT_NAME`, `AMPHUR_ID`, `PROVINCE_ID`, `GEO_ID`) VALUES
...
--
-- Indexes for table `default_district`
--
ALTER TABLE `default_district`
...
--
-- AUTO_INCREMENT for table `default_district`
--
ALTER TABLE `default_district`
